 ...
 * @extends {ActorSheet}
 */
export class InfinityActorSheet extends ActorSheet {

    /** @override */
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["infinity2d20", "sheet", "actor"],
            template: "systems/infinity2d20/templates/actor/actor-sheet.html",
            width: 600,
            height: 600,
    ...
    /** @override */
    get template() {
        return `systems/infinity2d20/templates/actor/actor-${this.actor.type}-sheet.html`;
    }
